        ...
        <div className="container mx-auto px-4 py-6 md:py-12">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start max-w-6xl mx-auto">
            <div className="order-1 md:order-1">
              <img src="/lovable-uploads/ee22247e-5122-41c5-ba85-664a60b0c1b4.png" alt="Students collaborating on laptop" className="rounded-2xl w-full animate-fadeIn transform hover:scale-[1.02] transition-transform duration-300" />
            </div>

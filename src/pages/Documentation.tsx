        ...
        <div className="grid md:grid-cols-[250px_1fr] gap-6 items-start">
          ...
          <div className="hidden md:block">
            <nav className="sticky top-4 space-y-2">
              <a href="#overview" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 py-1">
                <FileText className="w-4 h-4" />
                Overview
              </a>
              <a href="#quick-start" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 py-1">

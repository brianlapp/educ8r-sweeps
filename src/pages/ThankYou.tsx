...
const ThankYou = () => {
  ...
  const copyReferralLink = async () => {
    if (!referralLink) {
      toast({
        title: "Error",
        description: "No referral link available. Please try signing up again.",
        variant: "destructive",
      });
      return;
    }
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {referralCode ? (
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
              <h2 className="text-2xl font-semibold mb-4 text-red-600">Referral Link Not Available</h2>
              <p className="text-gray-600">
                We couldn't retrieve your referral link. This might happen if you refresh the page or visit this page directly.
                Please try signing up again to get a new referral link.
              </p>
            </div>
          )}

  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md mx-auto">
      {campaignLoading ? (
        ...
        <>
          <h2 className="text-2xl md:text-3xl lg:text-4xl mb-3 text-center text-[#2C3E50] font-bold font-poppins min-h-[64px] transition-all duration-200 line-clamp-2 leading-tight">
            {campaign?.title}
          </h2>
          {campaign?.subtitle && (
